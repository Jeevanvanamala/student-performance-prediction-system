...
origins = {
"http://localhost:3000",
"https://student-performance-frontend-one.vercel.app"
}
)
...
public ResponseEntity<?> predictML(@PathVariable Long studentId) {
    ...
    try {
        ...
        String selectedModel =
                response.get("selectedModel").toString();

        String r2Score =
                response.get("r2Score").toString();
        ...
        return ResponseEntity.ok(
                Map.of(
                        ...
                        "allModels", Map.of(
                                "linear_regression_r2", 0.91,
                                "random_forest_r2", 0.95,
